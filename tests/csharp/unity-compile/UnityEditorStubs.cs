...
namespace UnityEditor
{
    ...
    public static class EditorPrefs { public static bool GetBool(string k, bool d) => d; public static void SetBool(string k, bool v) {} public static void DeleteKey(string k) {} }
